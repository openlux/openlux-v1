...
//
// ASCOM Camera driver for openlux.k11
//
...
{
    //
    // Your driver's DeviceID is ASCOM.openlux.k11.Camera
    //
    // The Guid attribute sets the CLSID for ASCOM.openlux.k11.Camera
    // The ClassInterface/None attribute prevents an empty interface called
    // _openlux.k11 from being created and used as the [default] interface
    //
    ...
    /// ASCOM Camera Driver for openlux.k11.
    /// </summary>
    [Guid("207f5460-fd69-4d8d-86d7-40d064fe3feb")]
    ...
    public class Camera : ICameraV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.openlux.k11.Camera";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Camera Driver for openlux.k11.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="openlux.k11"/> class.
        /// Must be public for COM registration.
        /// </summary>
        /// 

        private Openlux openlux;

        public Camera()
        {
            openlux = new Openlux(this);

            tl = new TraceLogger("", "openlux.k11");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "openlux.k11 driver. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
        ...
        private const int ccdWidth = 4008; // Constants to define the CCD pixel dimensions
        private const int ccdHeight = 2672;
        private const double pixelSize = 9; // Constant for the pixel physical dimension
        ...
        /*private*/public bool cameraImageReady = false;
        ...
        public bool ImageReady
        {
            get
            {
                ...
                return IsReady() && cameraImageReady;// cameraImageReady;
            }
        }
        ...
        private DateTime readyAt = DateTime.Now;

        public bool IsReady()
        {
            return DateTime.Now.CompareTo(readyAt) > 0;
        }
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            readyAt = DateTime.Now.AddSeconds(Duration);

            openlux.startExposure(Duration);
